-- Repair: V20260647 is recorded in flyway_schema_history on some environments
-- but attendance_month_archive was never created (schema drift / partial apply).
-- Idempotent — safe when the table already exists.
