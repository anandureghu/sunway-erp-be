package com.hrmodule.config;

import com.hrmodule.security.JwtAuthenticationFilter;
import com.hrmodule.security.RestAuthenticationEntryPoint;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/", "/index.html", "/assets/**", "/static/**", "/app/**").permitAll()
